function ocp = optimal_tipin_ocp(x0, u0, xT, uT, N_ice, param)
...
% Model calculations
[xdot, h, signals] = LD2_pwl(x, u, N_ice, param);
...
% Create complete OCP
ocpDesc={'state_norm', param.ocp.state_norm, ...      % State normlization
