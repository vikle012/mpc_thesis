function [dXdt, signals, parameters] = EATS_model_test(X, V, U, parameters, signals)
...
%==========================================================================
% deNOx performance - Removed in test version
%==========================================================================
...
if nargout > 1
    if isempty(signals)
        ...
        signals.T_SCR(end+1,:)   = T_SCR(3);
    end

% signals=struct(...
%     'T_aDOC'  , T_aDOC - 273, ... To celcius
%     'T_aDPF'  , T_aDPF - 273, ... To celcius
%     'T_aSCR'  , T_aSCR - 273, ... To celcius
% ...    'deNOx'   , deNOx, ...
% ...    'NOx_TP'  , NOx_TP, ...
%     'T_SCR1'  , T_SCR(1), ...
%     'T_SCR2'  , T_SCR(2), ...
