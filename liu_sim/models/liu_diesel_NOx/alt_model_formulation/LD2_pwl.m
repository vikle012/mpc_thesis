function [dX, constraints, signals, param] = LD2_pwl(X, U, N_ice, param)
...
[p_cac, p_im, p_em, w_t, u_f, u_thr, u_wg] = enum(7);
[Du_f, Du_thr, Du_wg] = enum(3);

[dX_ld2, constraints, signals, param] = liu_diesel(X(p_cac:w_t), X(u_f:u_wg), N_ice, param);
