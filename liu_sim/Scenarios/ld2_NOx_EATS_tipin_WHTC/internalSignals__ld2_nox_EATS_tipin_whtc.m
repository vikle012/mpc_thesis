function z = internalSignals__ld2_nox_EATS_tipin_whtc(ld2_NOx_EATS_tipin, t_vec, x_vec, u_vec, t_label)

z = struct;

[~, ~, ~, parameters_used] = ld2_NOx_EATS_tipin(x_vec(1,:)', u_vec(1,:)', t_vec(1));
...
for k = 1:length(t_vec)
    ...
    [~, ~, c] = ld2_NOx_EATS_tipin(x_vec(k,:)', u_vec(k,:)', t_vec(k));
