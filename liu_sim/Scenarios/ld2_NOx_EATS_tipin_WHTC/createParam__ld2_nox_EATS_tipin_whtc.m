function param = createParam__ld2_nox_EATS_tipin_whtc(engine_map)
%% BUILD PARAM
...
%% ICE parameters and LOOK-UP TABLES
% Create look-up tables for NO and NO2/NO
...
param.ld2.constr.x_max = [pwl_param.constr.x_max(1:4); ...	ld2 states
    ...
    ones(EATS.DOC.n_seg + EATS.DPF.n_seg + EATS.SCR.n_seg + 2, 1).*1500; ... % Aftertreatment states
