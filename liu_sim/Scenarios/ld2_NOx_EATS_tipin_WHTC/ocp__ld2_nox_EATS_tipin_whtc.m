function [ocp, L, E] = ocp__ld2_nox_EATS_tipin_whtc(x0, u0, xT, uT, t0, tf, param)
...
[xdot, h, signals] = PT_PWL__ld2_nox_EATS_tipin_whtc(x, u, t, param, t0);
...
L = 'tipin, time';
E = 'null';
phaseData={'L', 1 ...signals.W_f ... + sqrt(((273+250-signals.T_aSCR)*1e-4)^2)  ... Integral cost (1 = time)
            ...'E', signals.NOx_tot ...
...
ocpDesc={'state_norm', param.ld2.ocp.state_norm, ...      % State normlization
         ...
         'obj_norm', 700};              % Obj. fn normalization
