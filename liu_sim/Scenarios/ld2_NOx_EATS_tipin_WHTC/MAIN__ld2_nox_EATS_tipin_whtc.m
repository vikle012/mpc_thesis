...
%   .m files:
%       createParam__ld2_nox_EATS_tipin_whtc
%       ocp__ld2_nox_EATS_tipin_whtc
%   	initGuess__ld2_nox_EATS_tipin_whtc
%       yopSolve_WHTC
%       PT_PWL__ld2_nox_EATS_tipin_whtc
%       internalSignals__ld2_nox_EATS_tipin_whtc
%       whtcPlots
%       ld2Plots
%       noxPlots
%
...
% April 2018; Last revision: 23-April-2018
...
if ~exist('param', 'var')
    param = createParam__ld2_nox_EATS_tipin_whtc(engine_map);
end
...
% States
x0 = [engine_map.state_calibration{M_index_init, N_index_init} .* 1, ... ld2 x0 min
...
% Controls
u0 = [engine_map.control_calibration{M_index_init, N_index_init}(1) .* 1, ... u_f min
...
xT = [param.ld2.constr.x_min(1), param.ld2.constr.x_max(1); ... p_cac [0.1, 5] bar
    ...
    param.ld2.constr.x_min(7:13), param.ld2.constr.x_max(7:13); ...
    473, param.ld2.constr.x_max(14); ...
    param.ld2.constr.x_min(15:18), param.ld2.constr.x_max(15:18) ...    
    ];
...
% Creating OCP
[ocp, info.L, info.E] = ocp__ld2_nox_EATS_tipin_whtc(x0, u0, xT, uT, t0, tf, param);

% Initial guess
v0 = initGuess__ld2_nox_EATS_tipin_whtc(x0, u0, t0, tf, param);
...
ld2_NOx_EATS = @(x, u, t) PT_PWL__ld2_nox_EATS_tipin_whtc(x, u, t, param, t0);
opt_signals = internalSignals__ld2_nox_EATS_tipin_whtc(ld2_NOx_EATS, t_opt, x_opt, u_opt);
