function ld2Plots(signals, engine_map)
% FUNCTION: Plotting signals related to engine
%
% SYNTAX: ld2Plots(input1, input2);
%
% INPUTS:
...
ax8 = subplot_hg(428);
plot_sig('Lambda')
plot([signals.t_vec.val(1) signals.t_vec.val(end)], signals.parameters.ld2.lambda_min*[1 1],'--')
...
ax6 = subplot_hg(426);
plot_sig('BSR')
plot([signals.t_vec.val(1) signals.t_vec.val(end)], signals.parameters.ld2.BSR_max*[1 1])
plot([signals.t_vec.val(1) signals.t_vec.val(end)], signals.parameters.ld2.BSR_min*[1 1])
