function [ocp, L, E] = ocp__hev_eats_ss_free_N(x0, u0, xT, uT, t0, tf, param)
% FUNCTION: Creates an optimal control problem 'ocp' to be used in the
%           optimization.
%
% SYNTAX: [output1] = ocp__hev_eats_ss_free_N(input1, input2, input3, input4, ...
...
%
% EXAMPLE:
%   ocp = ocp__hev_ss(x0, u0, xT, uT, 0, 1800, param)
%
...
[xdot, h, signals] = PT_PWL__hev_eats_ss_free_N(x, u, t, param, t0);
...
L = 'fuel';%'signals.NOx_TP';
E = 'null';
phaseData={'L', 1 ... signals.W_f ... signals.NOx_TP_Cu ... Integral cost (1 = time)
    ...'E', signals.NOx_tot ...
