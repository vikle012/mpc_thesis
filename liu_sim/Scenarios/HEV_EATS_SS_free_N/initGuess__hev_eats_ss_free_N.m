function v0 = initGuess__hev_eats_ss_free_N(x0, u0, t0, tf, param)
% FUNCTION: Simulating guessed control signals for initial guess of states
%           for the OCP.
%
% SYNTAX: output1 = initGuess__hev_eats_ss_free_N(input1, input2, input3,
%                                          	 input4, input5);
%
% INPUTS:
...
%
% EXAMPLE:
%   v0 = initGuess__hev_eats_ss_free_N(x0, u0, 45, 1170, param);
%
% OTHER FILES REQUIRED:
%   .m files:
%       PT_IG__hev_eats_ss_free_N
%       yopInitialGuess
%
%   .mat files:
%       none
...
hev = @(t,x) PT_IG__hev_eats_ss_free_N(x, u, t, param);
...
u_guess = repmat([0 0 0 0 0], length(t_sim), 1);
