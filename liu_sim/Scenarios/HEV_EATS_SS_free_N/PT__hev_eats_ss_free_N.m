function [dX, constraints, signals, param] = PT__hev_eats_ss_free_N(X, U, t, param, t0)
% FUNCTION: Wrapper for the model equations describing the dynamics of the
%           model.
%
% SYNTAX: [output1, output2, output3, output4] =
%           initGuess__hev_ss_free_N(input1, input2, input3, input4, input5);
%
% INPUTS:
...
% For easy indexing
[p_cac, p_im, p_em, w_tc, NOx, SOC, T_DOC_1, T_DOC_2, T_DPF_1, T_DPF_2, ...
...
[dX_ld2, c_ld2, signals.ld2] = liu_diesel_NOx_free_N(X(p_cac:NOx), U(u_f:N), param.ld2);    % ICE
