function ocp = newIG_ocp__hev_whtc(x0, u0, xT, uT, t0, tf, param)
% FUNCTION: Creates an optimal control problem 'ocp' to be used in the
%           optimization.
%
% SYNTAX: [output1] = newIG_ocp__hev_whtc(input1, input2, input3, input4, ...
...
%
% EXAMPLE:
%   ocp = newIG_ocp__hev_whtc(x0, u0, xT, uT, 0, 1800, param)
%
...
[xdot, h, signals] = newIG_PT_PWL__hev_whtc(x, u, t, param, t0);
...
phaseData={'L', -signals.W_f ...+ signals.W_f  ... Integral cost (1 = time)
            ...'E', signals.NOx_tot ...
