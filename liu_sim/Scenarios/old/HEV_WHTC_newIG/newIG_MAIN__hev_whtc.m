...
%   .m files:
%       newIG_createParam__hev_whtc
%       newIG_ocp__hev_whtc
%   	newIG_initGuess__hev_whtc
%       yopSolve_WHTC
%       newIG_PT_PWL__hev_whtc
%       newIG_internalSignals__hev_whtc
%       whtcPlots
%       ld2Plots
%       noxPlots
%       emPlots
...
if ~exist('param', 'var')
    param = newIG_createParam__hev_whtc(engine_map);
end
...
% Creating OCP
ocp = newIG_ocp__hev_whtc(x0, u0, xT, uT, t0, tf, param);
% Initial guess
v0 = newIG_initGuess__hev_whtc(x0, u0, t0, tf, param, percent);
...
hev = @(x, u, t) newIG_PT_PWL__hev_whtc(x, u, t, param, t0);
opt_signals = newIG_internalSignals__hev_whtc(hev, t_opt, x_opt, u_opt);
