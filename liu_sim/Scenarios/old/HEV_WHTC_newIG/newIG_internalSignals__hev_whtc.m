function z = newIG_internalSignals__hev_whtc(hev, t_vec, x_vec, u_vec, t_label)

z = struct;

[~, ~, ~, parameters_used] = hev(x_vec(1,:)', u_vec(1,:)', t_vec(1));
...
% Emissions
%z.NO2.title     = 'Out of engine NO_{2}';
%z.NO2.label     = 'NO_2 [ppm]';
%z.NO.title      = 'Out of engine NO';
%z.NO.label      = 'NO [ppm]';
z.NOx.title     = 'Out of engine NO_{x}';
z.NOx.label     = 'NO_{x} [g/s]';
%z.NO2NOx.title  = 'Out of engine NO_{2}/NO_{x}';
