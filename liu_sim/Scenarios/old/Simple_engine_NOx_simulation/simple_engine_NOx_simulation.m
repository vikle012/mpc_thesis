...
% Load NOx maps for plotting
load('no_model_map.mat')
load('no2_model_map.mat')
...
signals = internal_signals_NOx(@(x, u)ld2_NOx(x, u, N_ice_sim), ...
                                  t_sim, ...
                                  x_sim, ...
...
close all
ld2_NOx_plots(signals, engine_map, no_model_map, no2_model_map);
NOx_plots(signals);
