function [dX, constraints, signals, param] = PT__hev_eats_lightoff_whtc(X, U, t, param, t0)
% FUNCTION: Wrapper for the model equations describing the dynamics of the
%           model.
%
% SYNTAX: [output1, output2, output3, output4] =
%           initGuess__hev_lightoff_whtc(input1, input2, input3, input4, input5);
%
% INPUTS:
...
%
% EXAMPLE:
%   hev = @(x,u,t) PT__hev_lightoff_whtc(x, u, t, param, 0);
