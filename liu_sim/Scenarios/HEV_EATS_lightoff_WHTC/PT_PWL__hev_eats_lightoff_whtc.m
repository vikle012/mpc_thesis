function [dX, constraints, signals, param] = PT_PWL__hev_eats_lightoff_whtc(X, U, t, param, t0)
...
[dX_hev, constraints, signals, param] = ...
    PT__hev_eats_lightoff_whtc(X(p_cac:T_silencer_2), X(u_f:M_em), t, param, t0);
