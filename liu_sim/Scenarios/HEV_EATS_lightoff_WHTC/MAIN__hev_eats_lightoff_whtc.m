...
%   .m files:
%       createParam__hev_lightoff_whtc
%       ocp__hev_lightoff_whtc
%   	initGuess__hev_lightoff_whtc
%       yopSolve_WHTC
%       PT_PWL__hev_lightoff_whtc
%       internalSignals__hev_lightoff_whtc
%       whtcPlots
%       ld2Plots
%       noxPlots
%       emPlots
...
if ~exist('param', 'var')
    regen_brake = 1000; % Nm
    param = createParam__hev_eats_lightoff_whtc(engine_map, regen_brake);
end
...
% Creating OCP
[ocp, info.L, info.E] = ocp__hev_eats_lightoff_whtc(x0, u0, xT, uT, t0, tf, param);

% Initial guess
tic
v0 = initGuess__hev_eats_lightoff_whtc(x0, u0, t0, tf, param);
toc
...
hev = @(x, u, t) PT_PWL__hev_eats_lightoff_whtc(x, u, t, param, t0);
opt_signals = internalSignals__hev_eats_lightoff_whtc(hev, t_opt, x_opt, u_opt);
