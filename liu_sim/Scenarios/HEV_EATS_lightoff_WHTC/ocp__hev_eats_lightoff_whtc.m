function [ocp, L, E] = ocp__hev_eats_lightoff_whtc(x0, u0, xT, uT, t0, tf, param)
% FUNCTION: Creates an optimal control problem 'ocp' to be used in the
%           optimization.
%
% SYNTAX: [output1] = ocp__hev_lightoff_whtc(input1, input2, input3, input4, ...
...
%
% EXAMPLE:
%   ocp = ocp__hev_lightoff_whtc(x0, u0, xT, uT, 0, 1800, param)
%
...
% April 2018; Last revision: 24-April-2018
...
[xdot, h, signals] = PT_PWL__hev_eats_lightoff_whtc(x, u, t, param, t0);
...
L = 'time';
E = 'null';
phaseData={'L', 1  ... 1 ...+ signals.W_f  ... Integral cost (1 = time)
    ...'E', signals.NOx_tot ...
    'tf_min', t0 ... End time lower bound
...
ocpDesc={'state_norm', param.ld2.ocp.state_norm, ... % State normlization
    ...
    'obj_norm', 400}; % Obj. fn normalization
