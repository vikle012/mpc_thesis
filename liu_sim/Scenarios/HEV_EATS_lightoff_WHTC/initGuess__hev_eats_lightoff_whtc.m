function v0 = initGuess__hev_eats_lightoff_whtc(x0, u0, t0, tf, param)
% FUNCTION: Simulating guessed control signals for initial guess of states
%           for the OCP.
%
% SYNTAX: output1 = initGuess__hev_eats_lightoff_whtc(input1, input2, input3,
%                                          	 input4, input5);
%
% INPUTS:
...
%
% EXAMPLE:
%   v0 = initGuess__hev_eats_lightoff_whtc(x0, u0, 45, 1170, param);
%
% OTHER FILES REQUIRED:
%   .m files:
%       PT_IG__hev_eats_lightoff_whtc
%       yopInitialGuess
%
%   .mat files:
%       none
...
hev = @(t,x) PT_IG__hev_eats_lightoff_whtc(x, u, t, param);
