function [ocp, L, E] = ocp__ld2_nox_EATS_SS(x0, u0, xT, uT, t0, tf, param)
...
[xdot, h, signals] = PT_PWL__ld2_nox_EATS_SS(x, u, t, param, t0);
...
phaseData={'L', 1  ... Integral cost (1 = time)
            ... 'E', signals.NOx_tot ...
...
ocpDesc={'state_norm', param.ld2.ocp.state_norm, ...      % State normlization
         ...
         'obj_norm', 3000};              % Obj. fn normalization
