...
uT = [param.ld2.constr.x_min(8), param.ld2.constr.x_max(8); ... w_f [0, 280]
    ...
    param.ld2.constr.x_min(11), param.ld2.constr.x_max(11) ...  M_em [-1500, 1500]
    ];

%% SOLVE FOR OPTIMAL SOLUTION

% Creating OCP
[ocp, info.L, info.E] = ocp__hev_whtc(x0, u0, xT, uT, t0, tf, param);
% Initial guess
v0 = initGuess__hev_whtc(x0, u0, t0, tf, param);
