function [ocp, L, E] = phase2_ocp__hev_eats_lightoff(x0, u0, xT, uT, t0, tf, param)
...
L = 'fuel';
E = 'null';
phaseData={'L', signals.W_f  ... 1 ...+ signals.W_f  ... Integral cost (1 = time)
    ...'E', signals.NOx_tot ...
...
ocpDesc={'state_norm', param.ld2.ocp.state_norm, ... % State normlization
    ...
    'obj_norm', 1e-1}; % Obj. fn normalization
