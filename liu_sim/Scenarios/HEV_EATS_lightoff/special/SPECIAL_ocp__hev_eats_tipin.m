function [ocp, L, E] = SPECIAL_ocp__hev_eats_tipin(x0, u0, xT, uT, t0, tf, param)
% FUNCTION: Creates an optimal control problem 'ocp' to be used in the
%           optimization.
%
% SYNTAX: [output1] = ocp__hev_tipin(input1, input2, input3, input4, ...
...
%
% EXAMPLE:
%   ocp = ocp__hev_tipin(x0, u0, xT, uT, 0, 1800, param)
%
...
[xdot, h, signals] = PT_PWL__hev_eats_tipin(x, u, t, param, t0);
...
ocpDesc={'state_norm', param.ld2.ocp.state_norm, ... % State normlization
    ...
    'obj_norm', 0.5}; % Obj. fn normalization
