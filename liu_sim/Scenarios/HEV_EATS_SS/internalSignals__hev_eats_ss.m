function z = internalSignals__hev_eats_ss(hev_eats_ss, t_vec, x_vec, u_vec, t_label)

z = struct;

[~, ~, ~, parameters_used] = hev_eats_ss(x_vec(1,:)', u_vec(1,:)', t_vec(1));
...
for k = 1:length(t_vec)
    ...
    [~, ~, c] = hev_eats_ss(x_vec(k,:)', u_vec(k,:)', t_vec(k));
