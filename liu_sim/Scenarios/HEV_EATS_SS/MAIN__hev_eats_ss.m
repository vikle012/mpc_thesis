...
% Creating OCP
[ocp, info.L, info.E] = ocp__hev_eats_ss(x0, u0, xT, uT, t0, tf, param);
% Initial guess
v0 = initGuess__hev_eats_ss(x0, u0, t0, tf, param);
% test_check_v0;
...
opt_signals = internalSignals__hev_eats_ss(hev, t_opt, x_opt, u_opt);
