function [ocp, L, E] = ocp__hev_eats_ss(x0, u0, xT, uT, t0, tf, param)
% FUNCTION: Creates an optimal control problem 'ocp' to be used in the
%           optimization.
%
% SYNTAX: [output1] = ocp__hev_ss(input1, input2, input3, input4, ...
...
[xdot, h, signals] = PT_PWL__hev_eats_ss(x, u, t, param, t0);
...
E = 'null';
phaseData={'L', signals.W_f ...signals.NOx_TP_Fe  Integral cost (1 = time)
    ...'E', signals.NOx_tot ...
