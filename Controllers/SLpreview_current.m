classdef SLpreview_current < matlab.System & matlab.system.mixin.Propagates
    ...
    methods (Access = protected)
        ...
        function setupImpl(obj,~,~,~,~,~)
            ...
            f = casadi.Function('f', ...
                {A, B, K_c, X, U, X_ref, U_ref, U_old, X_0, U_0}, ...
                {Xtilde_dot, L});
            ...
            for k=0:obj.N-1
                ...
                [dx, q_k] = f(A, B, K_c, X_k, U_k, X_ref_k, U_ref_k, U_old, X_0, U_0);
