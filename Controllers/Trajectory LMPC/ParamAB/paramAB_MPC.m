classdef paramAB_MPC < matlab.System & matlab.system.mixin.Propagates
    ...
    methods (Access = protected)
        ...
        function setupImpl(obj,~,~,~,~,~)
            ...
            f = casadi.Function('f', {A, B, Xtilde, Utilde, Utilde_old}, {Xtilde_dot, L});
            ...
            obj.u_old = [110.976447879888; 15.3657549771663; 70.8311084176616];
            ...
            obj.func.A = casadi.Function('A', {X, U, n_e}, {jacobian(diesel_engine(X, U, n_e, model), X)});
            obj.func.B = casadi.Function('B', {X, U, n_e}, {jacobian(diesel_engine(X, U, n_e, model), U)});
        end
