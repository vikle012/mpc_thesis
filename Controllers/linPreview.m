classdef linPreview < matlab.System & matlab.system.mixin.Propagates
    ...
    methods (Access = protected)
        ...
        function setupImpl(obj,~,~,~,~,~)
            ...
            f = casadi.Function('f', ...
                {A, B, K_c, X, U, X_ref, U_ref, Utilde_old}, ...
                {Xtilde_dot, L});
        ...
        function u = stepImpl(obj,x,t,n_e,x_ref,u_ref)  
            ...
            utilde_old = obj.u_old - u_ref(:, it);
            p = utilde_old;     % Utilde_old = 3x1
